...
const RoadmapCreatePage = () => {
  ...
  const handleJobFile = (
    ...
    if (file.type !== "application/pdf") {
      setError(
        "Please upload the job description in PDF format."
      );
    ...
    <>
      ...
      <main className="roadmap-page">
        ...
        <div className="container roadmap-container">
          ...
          <motion.div
            className="roadmap-page-heading"
          ...
          >
            ...
            <h1>
              ...
              <br />
              preparation <span>roadmap.</span>
            </h1>

            <p>
              Choose a CS topic or upload a target job
              description. CorePrep AI will organize your
              preparation into a structured timeline.
            </p>
          </motion.div>

          <div className="roadmap-mode-grid">
            <button
              className={`roadmap-mode-card ${
                mode === "topic" ? "selected" : ""
              }`}
              onClick={() => selectMode("topic")}
            >
              <div className="roadmap-mode-icon">
                <Map size={24} />
              </div>
              ...
              <div>
                ...
                <p>
                  Prepare systematically for a specific
                  computer science subject.
                </p>
              </div>

              {mode === "topic" && (
                <Check className="roadmap-selected-check" />
              )}
            </button>
            ...
            >
              ...
              <div>
                <span>JOB FOCUSED</span>
                <h3>Upload Job Description</h3>

                <p>
                  Build preparation around a target
          ...
          <section className="roadmap-builder-card">
            {mode === "topic" ? (
              <>
                <div className="roadmap-builder-heading">
                  <Map size={21} />

                  <div>
                    <h2>Select Your Topic</h2>
                    <p>
                      Choose the subject you want to prepare.
                    </p>
                  </div>
                </div>
                ...
                <div className="roadmap-topic-grid">
                  {SUPPORTED_TOPICS.map((item) => (
                    <button
                      ...
                      className={
                        topic === item
                          ? "roadmap-topic-option selected"
                          : "roadmap-topic-option"
                      }
              ...
              <>
                <div className="roadmap-builder-heading">
                  ...
                  <div>
                    ...
                    <p>
                      Upload the target role in PDF format.
                    </p>
                  </div>
                </div>

                <label className="roadmap-job-upload">
                  <input
                    type="file"
                  ...
                  {jobFile ? (
                    ...
                    <>
                      ...
                      <span>
                        The AI skill extraction will be
                        connected later.
                      </span>
                    </>
                  )}
            ...
            <div className="roadmap-timeline-section">
              <div className="roadmap-builder-heading">
                ...
                <div>
                  ...
                  <p>
                    Minimum{" "}
                    {mode === "topic" ? "4" : "6"} weeks
                    for this roadmap.
                  </p>
                </div>
              </div>

              <div className="roadmap-week-options">
                {timelineOptions.map((option) => (
                  <button
                    key={option}
                    className={
                      weeks === option
                        ? "roadmap-week selected"
                        : "roadmap-week"
                    }
